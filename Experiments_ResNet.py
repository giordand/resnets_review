...
experimentos = {
    ...
    'E2':['relu',None,None,None],
    'E3':['relu','relu',None,None],
    'E4':['relu','relu','relu',None],
    'E5':[None,None,None,'relu'],
    'E6':[None,'relu',None,'relu']
}
n = args['n'][0]
EPOCHS=args['e'][0]
activations = args['a']
...
net = tflearn.residual_block(net, 1, 32, downsample=True,activation=activations[1])
net = tflearn.residual_block(net, n-1, 32,activation=activations[1])
net = tflearn.residual_block(net, 1, 64, downsample=True,activation=activations[2])
...
model_name = str(layers)+'_layers'+'_'+suffix
